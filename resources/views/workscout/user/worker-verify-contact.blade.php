    ...
    <div class="container">
        ...
        <div class="sixteen columns margin-top-30">
            ...
            <div class="notification warning closeable align-center">
                Kami sudah mengirimkan sms berisi kode verifikasi. Silahkan masukkan kode di sms untuk memverifikasi kontak pekerja anda.
            </div>
            ...
            <div class="submit-page">
                ...
                <form role="form" method="POST" id="form-job-create">
                    ...
                    <a class="custom-link send-code">KIRIM ULANG KODE</a>
