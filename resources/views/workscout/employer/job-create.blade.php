...
<div class="sixteen columns">
    ...
    <div class="submit-page">
        ...
        <div class="form">
            ...
            <input class="search-field" name="title" value="{{old('title')}}" type="text" placeholder="Contoh : Supir Pribadi, Penjaga Toko Di Mall, Juru Masak Restoran Chinese Food" />
        </div>
        ...
        <div class="form">
            <h5>Gaji</h5>
            <input class="search-field" name="salary_min" style="width: 49%;margin-right: 15px;float: left" value="{{old('salary_min')}}" type="text" placeholder="Gaji minimal. Isi dengan angka">

            <input class="search-field" name="salary_max" style="width: 49%" value="{{old('salary_max')}}" type="text" placeholder="Gaji maksimal. Isi dengan angka">
        </div>
            ...
            <div class="form">
                ...
                <input class="search-field" name="start_date" style="width: 49%;margin-right: 15px;float: left" value="{{old('start_date')}}" id="from" type="text" placeholder="Tanggal lowongan dimulai">

                <input class="search-field" name="end_date" style="width: 49%" value="{{old('end_date')}}" type="text" id="to" placeholder="Tanggal lowongan berakhir">
            </div>
        ...
        <div class="form">
            ...
            <div class="form">
                <h5>Umur Pekerja</h5>
                <input class="search-field" name="age_min" style="width: 49%;margin-right: 15px;float: left" value="{{old('age_min')}}" type="text" placeholder="Umur minimal">

                <input class="search-field" name="age_max" style="width: 49%" value="{{old('age_max')}}" type="text" placeholder="Umur maksimal">
            </div>
